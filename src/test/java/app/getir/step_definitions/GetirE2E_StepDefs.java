...
import app.getir.pages.DondurmaPage;
...
public class GetirE2E_StepDefs {
    ...
    DondurmaPage dondurmaPage = new DondurmaPage();
    ...
    public void user_clicks_on_the_basket_button() throws InterruptedException {
        mainPage.basketBtn.click();
        Thread.sleep(3000);
    }
    @Then("verify that basket is empty and text is {string}")
    public void verify_that_basket_is_empty_and_text_is(String expectedResultTxt) throws InterruptedException {
    ...
    public void user_makes_scroll_and_adds_two_item(List<String> dataTable) {
        dondurmaPage.addItem(dataTable.get(0));
        dondurmaPage.addItem(dataTable.get(1));
    }
